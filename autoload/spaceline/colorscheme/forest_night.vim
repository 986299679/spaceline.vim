...
" License: MIT License
" =============================================================================
function! spaceline#colorscheme#forest_night#forest_night()
  let s:slc = {}
  let s:slc.yellow = ['e39b7b', 214]
  let s:slc.navy = ['505a60', 237]
  let s:slc.lightgray = ['3c474d', 188]
  let s:slc.purple = ['83b6af', 261]
  let s:slc.orange = ['7c8377', 208]
  let s:slc.red = ['ec5f67', 203]
  let s:slc.blue = ['83b6af', 32]
